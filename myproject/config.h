...
# ifdef GR
    ...
    #define ORIGINAL_DATASET (std::string)"/Users/giuliorusso/Library/Mobile Documents/com~apple~CloudDocs/Documents/Istruzione/Universita/Magistrale/Advanced Image Analysis/Progetto/Parking-sign-recognition/subset-EIID-AIA-parking-enum"
    // preprocessed dataset chosen for the analisys (meanshift 5-5 or meanshift 5-5 + clahe 1)
    #ifdef USE_CLAHE
        #define PREPROCESSED_DATASET (std::string)"/Users/giuliorusso/Library/Mobile Documents/com~apple~CloudDocs/Documents/Istruzione/Universita/Magistrale/Advanced Image Analysis/Progetto/Parking-sign-recognition/subset-EIID-AIA-parking-meanshift5-clahe1"    //meanshift 5,5 + clahe 1
    #else
        #define PREPROCESSED_DATASET (std::string)"/Users/giuliorusso/Library/Mobile Documents/com~apple~CloudDocs/Documents/Istruzione/Universita/Magistrale/Advanced Image Analysis/Progetto/Parking-sign-recognition/subset-EIID-AIA-parking-meanshift5"            //meanshift 5,5
    #endif
    // save the contours of the signals detected
    #define OUTPUT_DATASET (std::string)"/Users/giuliorusso/Library/Mobile Documents/com~apple~CloudDocs/Documents/Istruzione/Universita/Magistrale/Advanced Image Analysis/Progetto/Parking-sign-recognition/output"

    // to create a new preprocessed dataset
    #define PREPROCESSING_FOLDER (std::string)"/Users/giuliorusso/Library/Mobile Documents/com~apple~CloudDocs/Documents/Istruzione/Universita/Magistrale/Advanced Image Analysis/Progetto/Parking-sign-recognition/subset-EIID-AIA-parking-meanshift5-clahe1"
    // contains the .csv file used to save scores and labels(TP/FP)
    #define PERFORMANCE_FOLDER (std::string)"/Users/giuliorusso/Library/Mobile Documents/com~apple~CloudDocs/Documents/Istruzione/Universita/Magistrale/Advanced Image Analysis/Progetto/Parking-sign-recognition/"
    // contains the "P" templates used by matchShape() function
    #define TEMPLATE_FOLDER (std::string)"/Users/giuliorusso/Library/Mobile Documents/com~apple~CloudDocs/Documents/Istruzione/Universita/Magistrale/Advanced Image Analysis/Progetto/Parking-sign-recognition/template-set-P"
